...
//  ReciteTest
//
//  Created by 赵永杰 on 16/12/4.
//  Copyright © 2016年 zhaoyongjie. All rights reserved.
//

#import "HLAVMixObject.h"
#import <AVFoundation/AVFoundation.h>

@interface HLAVMixObject ()

@property (nonatomic, strong) NSMutableArray *audioMixParams;

@end

@implementation HLAVMixObject
...
/**
 ...
 @param firstAudioURL  第一个音频的url
 @param secondAudioURL 第二个音频的url
 @param videoURL       视频的url
 @param outputURL      合成视频的url
 @param complete       完成的回调
 */
